...
### Working at the moment on
  ...
  - [Space Survivor](https://github.com/B9R9/Space_Survivor): My own first game !!! Inspired by Vampire Survivor, You will try to survice in
 dangerous space.
...
### My 42 projects
  ...
  - [Corewar](https://github.com/MargotDem/corewar): This project involves creating a virtual arena, and having simplistic-language programs fight each other. You will get acquainted with VM conception (with the instructions it recognizes, the registers, etc.) and compilation problems of an assembly language in bytecode. In bonus, you’ll have the pleasure of having your champions fight in the arena.
